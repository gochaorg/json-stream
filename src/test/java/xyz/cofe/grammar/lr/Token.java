...
public interface Token {
    interface Source<C,SELF extends Source<C,SELF>> {
        SELF move(int offset);
        Optional<C> get();
        int substract(SELF other);
    }

    interface StringSource extends Source<Character,StringSource> {}

    record ParsedToken<R,S extends Source<?,?>>( R token, S begin, S end ) {}
